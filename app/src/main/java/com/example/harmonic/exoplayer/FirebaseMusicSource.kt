...
import com.example.harmonic.data.remote.MusicDatabase
    ...
    private var state: State = State.STATE_CREATED
        set(value) {
            if (value == State.STATE_INITIALIZED || value == State.STATE_ERROR) {
                synchronized(onReadyListeners) { //The synchronized(onReadyListeners){} block ensures that the onReadyListeners list is accessed in a thread-safe manner.
                    field = value
