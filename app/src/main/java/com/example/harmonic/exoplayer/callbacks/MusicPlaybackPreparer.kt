package com.example.harmonic.exoplayer.callbacks
...
import com.example.harmonic.exoplayer.FirebaseMusicSource
...
class MusicPlaybackPreparer(
    ...
    override fun onPrepareFromMediaId(mediaId: String, playWhenReady: Boolean, extras: Bundle?) {
        firebaseMusicSource.whenReady {
            ...
            playerPrepared(itemToPlay) // yhi par check krenge kaun sa song play hoga
        }
    }
